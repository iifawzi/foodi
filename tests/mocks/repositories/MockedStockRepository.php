...
class MockedStockRepository implements StockRepository
{
    ...
    {
        $this->data = [
            1 => ["id" => 1, "merchantId" => 1, "name" => "Beef", "description" => 'Beef 1', "fullQuantity" => 2000, "availableQuantity" => 2000, "thresholdPercentage" => 50, "stockTransactions" => []],
            2 => ["id" => 2, "merchantId" => 1, "name" => "Cheese", "description" => 'Cheese 1', "fullQuantity" => 500, "availableQuantity" => 500, "thresholdPercentage" => 50, "stockTransactions" => []],
            3 => ["id" => 3, "merchantId" => 1, "name" => "Onion", "description" => 'Onion 1', "fullQuantity" => 200, "availableQuantity" => 200, "thresholdPercentage" => 50, "stockTransactions" => []],
        ];
    }
